...
const Hotelimage = () => {
  ...
  return (
 <div>
    <Grid container spacing={0.5} sx={{height:'100vh',width:'90vw',marginTop:'32px',border:'1px solid black',marginLeft:'104px',marginRight:'104px',alignItems: 'stretch',justifyContent: 'flex-start'}}>
