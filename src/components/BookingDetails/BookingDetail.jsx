...
<Box sx={{ marginLeft:'50px',padding:'4vh', height: '184px', width:'742px', alignItems:'center',  border: '1px solid #000',
  borderRadius: '10px'}} >
...
>
  <Box sx={{ margin:'50px', marginLeft:'30px',padding:'2vh', height: 'wrap', width:'575px', alignItems:'center',border:'1px solid #000', 
  borderRadius: '10px'}} >
