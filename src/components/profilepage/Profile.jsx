...
const Profilepage = () => {
  ...
  return (
    <div>
      <Box padding="70px">
        <Box paddingTop="70px" sx={{ width: '1300px', height: '350px', position: 'relative' }} >
              ...
              <div style={{
                ...
                <Button onClick={() => fileInputRef.current?.click()} sx={{marginBottom:'-0.2%'}}>
                  <div style={{ display: 'inline-block', borderRadius: '60%', backgroundColor: '#FF8682',padding:'1.5px',height:'30px' ,width:'30px',bottom:'10px',right:'10px' ,marginLeft:"10px",marginBottom:'-1px'}}>
                    <img src={pen} alt="Pen" sx={{marginTop:2,width:'9px',height:'9px'}} /></div></Button>
              </div>
            </div>
        ...
        <Box paddingTop="200px" sx={{ height: '592px', width: '1232px', marginLeft: '70px', marginRight: '120px',marginBottom:'300px' }}>
          <Typography variant="p3" sx={{ fontSize: '32px', fontWeight: 700, paddingBottom: '4px' }}>
            Account
          </Typography> <br />
          <Paper elevation={4} sx={{ padding: 4, width: '1232px', borderRadius: '10px', marginTop: 2 }}>
            <Grid container direction="column" spacing={4}>
              ...
              <Grid item container justifyContent="space-between" alignItems="center">
                <Grid item>
                  ...
                  ) : (<Typography variant="p1">{anotherEmail}</Typography>)}

                </Grid>

                <Grid item >
                  <Button variant='outlined' onClick={() => setIsAnotherEmailEditing(true)}><Typography variant="p2"><img src={Add} />Add another email</Typography></Button>
