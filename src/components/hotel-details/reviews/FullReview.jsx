...
>>>>>>> 02558994dc752dbead708455f5f10fa97f972569
  ...
  return (
    <>
          ...
          <Container variant="outlined" style={{ maxWidth: 1232, maxHeight:'100%', margin: "0 auto"}}>
            ...
            />
            <ListOfReviewsContainer reviews={reviews} setReviews={setReviews} averageRating={averageRating} />
          </Container>
    </>
  );
}
